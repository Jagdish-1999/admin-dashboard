...
const TableCounter = ({ totalCount, currentCount }: TableCounterProps) => {
  return (
    <TableRow className="w-fit p-2 px-8 absolute left-1/2 -translate-x-1/2 bottom-4 rounded-full bg-transparent border border-neutral-500/10 backdrop-blur-md transition-all duration-200 z-10 opacity-100 hover:opacity-0">
